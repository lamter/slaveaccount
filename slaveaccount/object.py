...
class VtBankAccountData(VtBaseData):
    """银行账户数据类"""

    # ----------------------------------------------------------------------
    def __init__(self):
        """Constructor"""
        super(VtBankAccountData, self).__init__()
        # 账号代码相关
        self.bankAccount = EMPTY_STRING  # 银行账号
        self.customerName = EMPTY_STRING  # 账号人名
        self.currencyID = EMPTY_STRING  # 币种 CNY
        self.brokerBranchID = EMPTY_STRING  # 券商分支机构ID
        self.bankID = EMPTY_STRING  # 银行编号 中国银行:3
        self.bankBranchID = EMPTY_STRING  # 分行ID
        self.brokerID = EMPTY_STRING  # 券商ID
        self.accountID = EMPTY_STRING  # 期货账号

        # self.custType = EMPTY_STRING
        # self.identifiedCardNo = EMPTY_STRING  # 身份证号码
        # self.regDate = EMPTY_STRING  #   注册日期
        # self.outDate = EMPTY_STRING
        # self.TID = EMPTY_INT
        # self.openOrDestroy = EMPTY_STRING  #
        # self.tradeDay = EMPTY_STRING
        # self.bankAccType = EMPTY_STRING
        # self.idCardType = EMPTY_STRING


class VtTransferSerialData(VtBaseData):
    """出入金数据"""

    # ----------------------------------------------------------------------
    def __init__(self):
        """Constructor"""
        super(VtTransferSerialData, self).__init__()

        # self.tradeTime = EMPTY_STRING
        # self.tradeDate = EMPTY_STRING
        self.tradingDay = EMPTY_STRING
        self.tradeDatetime = None  # datetime.datetime

        # 当日的流水号，（可能是当日的）唯一标志
        self.futureSerial = EMPTY_INT

        self.bankNewAccount = EMPTY_STRING
        self.brokerBranchID = EMPTY_STRING
        self.operatorCode = EMPTY_STRING
        self.accountID = EMPTY_STRING
        self.bankAccount = EMPTY_STRING
        self.tradeCode = EMPTY_STRING
        self.bankBranchID = EMPTY_STRING
        self.sessionID = EMPTY_INT
        self.bankID = EMPTY_STRING
        self.plateSerial = EMPTY_INT
        self.futureAccType = EMPTY_STRING
        self.errorID = EMPTY_INT
        self.bankSerial = EMPTY_STRING
        self.identifiedCardNo = EMPTY_STRING
        self.brokerID = EMPTY_STRING
        self.idCardType = EMPTY_STRING
        self.custFee = EMPTY_FLOAT
        self.currencyID = EMPTY_STRING
        self.errorMsg = EMPTY_STRING
        self.bankAccType = EMPTY_STRING
        self.investorID = EMPTY_STRING
        self.brokerFee = EMPTY_FLOAT
        self.tradeAmount = EMPTY_FLOAT
        self.availabilityFlag = EMPTY_STRING
...
class VtSaveMongodbData(object):
    def __init__(self, func, args=None, kwargs=None):
        self.func = func
        self.args = args or tuple()
        self.kwargs = kwargs or {}
